-- New club applications use one student-benefit description. Keep the
-- legacy database columns populated consistently for existing consumers.

-- The base RPC is an internal implementation detail. The public submission
-- entry point below supplies the same value to every legacy description field.
