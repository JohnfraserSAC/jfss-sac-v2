-- Remove the obsolete 15-argument overload. Its default parameters make
-- calls to the current supervisor-name version ambiguous in PostgreSQL.
drop function if exists public.submit_club_registration_application_with_details(
  uuid, text, text, text, text, text[], text, text, text, text, text[],
  text, text, text, text
);

-- Keep one unambiguous RPC for the current new-club form.
